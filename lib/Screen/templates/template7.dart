...
class Template7 extends StatelessWidget {
  ...
  Template7({required this.userId});
...
class Template7 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text(userData["templateName"] ?? "Column Template"),
            actions: [
              IconButton(
                icon: Icon(Icons.picture_as_pdf),
                onPressed: () async {
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildOptionalSection("Contact",
                            _formatMap(userData["contactDetails"] ?? {})),
                        _buildOptionalSection(
                            "Skills", _formatList(userData["skills"] ?? [])),
                        _buildOptionalSection("Education",
                            _formatList(userData["education"] ?? [])),
  ...
  // UI Section Builder (Shows Only if Not Empty)
  Widget _buildOptionalSection(String title, List<String> items) {
    if (items.isEmpty) return SizedBox();
    return _buildSection(title, items);
  }
  ...
  // PDF Section Builder (Shows Only if Not Empty)
  pw.Widget _buildOptionalPdfSection(String title, List<String> items) {
    if (items.isEmpty) return pw.SizedBox();
    return _buildPdfSection(title, items);
  }
  ...
  // Utility: Convert a List<dynamic> to List<String>
  List<String> _formatList(dynamic data) {
    if (data is List) {
      return data
          .where((e) => e != null && e.toString().isNotEmpty)
  ...
  // Utility: Convert a Map<String, dynamic> to List<String>
  List<String> _formatMap(Map<String, dynamic> data) {
    return data.entries
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 20),
                  // Right Column (Contact, Skills, Awards & Certificates)
                  Expanded(
                    flex: 1,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
...
class Template7 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        // Debug: Print the userData to check its structure
  ...
  // PDF Section Builder (Shows Only if Not Empty)
  pw.Widget _buildOptionalPdfSection(String title, List<String> items) {
    print("Building PDF Section: $title");
    print("Items: $items");
  ...
  // Utility: Convert a List<dynamic> or String to List<String>
  List<String> _formatList(dynamic data) {
    if (data is List) {
      return data
          .where((e) => e != null && e.toString().isNotEmpty)
      ...
      return [data]; // Convert string to a list with one item
